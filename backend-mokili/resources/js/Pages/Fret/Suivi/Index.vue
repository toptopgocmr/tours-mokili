...
<template>
    <Head title="Mes expeditions" />
    <div class="mx-auto max-w-7xl px-6 py-12">
        <h1 class="text-3xl font-bold text-navy-900">Mes expeditions</h1>
        <p class="mt-1 text-navy-700">Suivi de vos expeditions et colis.</p>
        <div class="mt-8 space-y-3">
            <Link v-for="s in shipments.data" :key="s.id" :href="`/fret/mes-envois/${s.id}`" class="flex items-center justify-between rounded-xl border p-4 hover:shadow-sm">
                <div>
