...
const links = [
    ...
    { href: '/admin/voyage', label: 'Offres Voyage' },
    { href: '/admin/reservations', label: 'Reservations' },
    { href: '/admin/utilisateurs', label: 'Agents & Partenaires' },
];
</script>
    ...
    <div class="flex min-h-screen bg-navy-50/40">
        <aside class="hidden w-64 flex-col bg-navy-900 text-white md:flex">
            <div class="px-6 py-5 text-lg font-bold">
                ...
                <div class="text-xs font-normal text-navy-50/60">Back-office</div>
            </div>
        ...
        <div class="flex-1">
            <header class="flex items-center justify-between border-b bg-white px-6 py-4 md:hidden">
                <span class="font-bold text-navy-600">MOKILI TOUR - Back-office</span>
            </header>
